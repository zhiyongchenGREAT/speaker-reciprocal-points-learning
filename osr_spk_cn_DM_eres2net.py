...
# Dataset
parser.add_argument('--dataset', type=str, default='deepmine')
parser.add_argument('--outf', type=str, default='./ckpt/DeepMine')
...
def main_worker(options):
    ...
    # Dataset
    Data = SpeakerDataloader(known=list(range(15)), train_root='./data/DeepMine/emb_train', 
                             test_root='./data/DeepMine/emb_test', batch_size=options['batch_size'])
    trainloader, testloader, outloader = Data.train_loader, Data.test_loader, Data.out_loader
    if options['cs_my'] or options['cs']:
        Data1 = SpeakerDataloader_tmp(known=list(range(40,63)), train_root='./data/DeepMine/emb_train_unknown_control', 
        test_root='./data/DeepMine/emb_train_unknown_control', batch_size=options['batch_size']*3)
    ...
    filename = './ckpt/DeepMine/checkpoints/classifier32_ARPLoss_False_.pth'
    ...
    file_name = '{}_{}_{}'.format(options['model'], options['loss'], options['cs_my'])
