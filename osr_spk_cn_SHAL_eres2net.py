...
# Dataset
parser.add_argument('--dataset', type=str, default='SHAL')
parser.add_argument('--outf', type=str, default='./ckpt/SHAL')
...
def main_worker(options):
    ...
    # Dataset
    Data = SpeakerDataloader(known=list(range(25)), train_root='./data/SHALCAS22A/emb_train', 
                             test_root='./data/SHALCAS22A/emb_test', batch_size=options['batch_size'])
    trainloader, testloader, outloader = Data.train_loader, Data.test_loader, Data.out_loader
    if options['cs_my'] or options['cs']:
        Data1 = SpeakerDataloader_tmp(known=list(range(60,85)), train_root='./data/SHALCAS22A/emb_train_unknown_control', 
        test_root='./data/SHALCAS22A/emb_train_unknown_control', batch_size=options['batch_size']*3)
    ...
    filename = './ckpt/SHAL/checkpoints/classifier32_ARPLoss_False_.pth'
